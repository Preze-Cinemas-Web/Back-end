...
namespace CinemaStore.Business
{
    public class UserService : IUserService
    {
        ...
        {
            var usersList = this._mapper.Map<IEnumerable<UserDTO>>(_context.User); // Μετατροπή από List<Users> (Data) -> List<UsersDTO> (Store)
        ...
        public UserDTO CreateUser(UserDTO u)
        {
             ...
             */
            User user = this._mapper.Map<User>(u); // Μετατρέπω το UsersDTO (Store) -> Users (Data)
