...
{
    public class CinemaDevelopmentContext : DbContext
    {
        public CinemaDevelopmentContext()
        {
        }

        public CinemaDevelopmentContext(DbContextOptions<CinemaDevelopmentContext> options)
            : base(options)
        {
        }
